...
serveraddr=apinterface.GetAddress(0).ConvertTo()
print(apinterface.GetAddress(0))
...
#Configure every packet size as 1024 bytes
clientApps1 = echoClient1.Install(wifiStaNodes.Get(3))
#Connect UDP echo client application to wifi node with index
#nwifi.value-1 since it started from 0
...
serverApps = echoServer.Install(wifiApNodes.Get(0))
